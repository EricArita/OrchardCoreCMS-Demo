export class Constants {
  ...
  public static apiContent = 'https://localhost:5001/api/content';
  public static apiDocument = 'https://localhost:5001/api/document'
  public static apiN8N = 'http://localhost:5678/webhook/tor-submitted'
}
